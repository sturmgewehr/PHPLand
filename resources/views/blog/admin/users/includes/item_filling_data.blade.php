        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="email" value="{{ $item['user']['email'] }}" disabled>
                </div>
                <div class="form-check">
                    <input type="hidden" name="is_banned" value="0">

                    <input class="form-check-input" type="checkbox" name="is_banned" value="1"
                           @if($item['user']['is_banned']) checked @endif
                           @if($item['user']['is_admin'] === 1  ) disabled @endif>
